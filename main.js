// main.js - lógica principal da app

// Obter definições do localStorage
function getDefs() {
  return JSON.parse(localStorage.getItem('definicoesMB')) || {};
}

// Preencher dropdown de aviões
...
window.onload = () => {
  preencherDropdown();
  calculate();
  document.querySelectorAll("input[type='number']").forEach((input, index, arr) => {
  ...
  // Registar o SW aqui também, centralizado
  if ('serviceWorker' in navigator) {
    navigator.serviceWorker.register('service-worker.js')
      .then(() => console.log("✔️ Service Worker registado"))
